...
The current binary exposes help for the top-level command tree, accepts global flags, and renders skeletal command status in human, JSON, NDJSON, or quiet modes:
