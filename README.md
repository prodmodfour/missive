...
* a clap-based CLI skeleton with stable top-level commands and global flags
...
The current binary exposes help for the top-level command tree and accepts global flags:
...
See [`docs/cli.md`](docs/cli.md) for the current skeleton. Future tickets add command behaviour, output rendering, configuration, A2A integration, persistence, gateway, adapters, collectives, tests, and packaging.
