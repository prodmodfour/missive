...
| `tasks` | Tracks local and remote task IDs, agent/context linkage, task state, protocol version, remote task JSON, and metadata. | Keep active tasks until terminal. Terminal task retention remains future work. |
